...
<html>
<head>
<title>MIT Inc and Sons Ltd - My Orders</title>
	...
	<div class="div1">
		...
		<%
			...
			try (Connection con = DriverManager.getConnection(url, uid, pw);) {
				...
				String SQL = "SELECT O.OrderId, OrderDate, totalAmount, userid FROM OrderSummary AS O JOIN Customer as C ON O.CustomerId = C.CustomerId AND userid = '" + userName + "'";
				...
				while (orders.next()) {
					out.print("<tr><td>" + orders.getInt(1) + "</td>" + "<td>" + orders.getDate(2) + " "
							+ orders.getTimestamp(2) + "</td>" + "<td>"
							+ orders.getBigDecimal(3) + "</td></tr>");
